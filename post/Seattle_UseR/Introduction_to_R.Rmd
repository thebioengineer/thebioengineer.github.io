...
.pull-right[
.center[![Its ME!](Introduction_to_R_files/Ellis_LinkedIn.jpg)]
]
...
.center[![New](Introduction_to_R_files/New_Script.PNG)]
...
- Instructions are sent to your computer one line at a time
    - in R, a line is run by
        - either cliking the "Run" button ![Run](Introduction_to_R_files/run_button.PNG)
        - ctrl + enter
...
### Names
.pull-left[<img src="Introduction_to_R_files/sees_assorted_Select.jpg"/>]
.pull-right[
...
- If each column of the chocolates box on the left had a name describing its contents
    - "dark_round", "swirled_round", "light_round", "swirled_square"
...
![df description](Introduction_to_R_files/data_frame_help.PNG)
...
![df row description](Introduction_to_R_files/data_frame_help_rownames.PNG)
...
# Once again, a big thank you to Fred Hutch for allowing us to use this space
